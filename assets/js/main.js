...
(() => {
  ...
  if(header){
    header.innerHTML = `<header class="site-header"><div class="container nav">
      <a class="brand" href="${href('index.html')}" aria-label="Sunny Day Orebić"><img class="brand-logo" src="${assetPrefix}assets/images/logo-sunny-day-light.png" alt="Sunny Day Orebić"></a>
  ...
  if(footer){footer.innerHTML=`<footer class="footer"><div class="container"><div class="footer-grid">
    <div><a class="footer-logo-link" href="${href('index.html')}" aria-label="Sunny Day Orebić"><img class="footer-logo" src="${assetPrefix}assets/images/logo-sunny-day-light.png" alt="Sunny Day Orebić"></a><p>${isEN?'A refined base for sea-view stays, poolside days and discovering the Pelješac peninsula.':'Elegantna baza za boravak uz more, opuštanje uz bazen i otkrivanje Pelješca.'}</p></div>
